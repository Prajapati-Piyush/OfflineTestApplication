...
package offlinetestapplication;;
...
class OfflineTestApplication extends JFrame implements ActionListener  
{  
    JLabel l;  
    ...
    int m[]=new int[10];      
    OfflineTestApplication(String s)  
    {  
        super(s);  
        l=new JLabel();  
        add(l);  
    ...
    {  
        new OfflineTestApplication("Online Test Of Java");  
    }  
}  